...
public class CountryController {
  ...
  // Page<Country> countries = countryService.getCountries(page, size, sortBy,
  // order);
  // PagedModel<EntityModel<Country>> pagedCountries =
  // pagedResourcesAssembler.toModel(countries);
  ...
  public ResponseEntity<?> getCountryByName(@PathVariable String name) {
    // EntityModel<Country> entityModel =
    // assembler.toModel(countryService.getCountyByName(name));
